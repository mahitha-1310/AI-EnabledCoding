...
The code for the agent integrated with the IDE is available in the `integrate-ide` branch.
All setup instructions and usage details are provided in the README within that branch.
