...
/*
 * THIS FILE CONTAINS AN ERROR ON LINE 30
 * The 'calculate_area' function has not been defined nor forward-declared
 * at this point, and as a result should generate a COMPILER ERROR
 */
