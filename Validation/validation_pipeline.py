...
from utils import get_user_paths, transfer

class ValidationPipeline:
    """Pipeline for validating code files generated by the LLM"""

    def __init__(self, output_dir: str, source_dir: str, user_id: str, prompt: str = None):
        """
    ...
    def run(self) -> Dict[str, Dict[str, Any]]:
        ...
        transfer(get_user_paths(self.user_id).test_path, unit_testing_logs_dir)
